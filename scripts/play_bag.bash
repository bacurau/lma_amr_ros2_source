...
[[ $choosen_item -eq 1 ]] && topics_to_exclude+=("clock" "joint_states")

tmux new-session -d -s $session_name

tmux split-window -h

tmux send-keys -t $session_name:0.1 "./main.bash $choosen_item; sleep 5; exit 0" ENTER  # Number used to choose launch file in main.bash.

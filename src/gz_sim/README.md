...
* `gz_sim_description` - holds the sdf description of the simulated system and any other assets.

* `gz_sim_gazebo` - holds gazebo specific code and configurations. Namely this is where systems end up.

* `gz_sim_application` - holds ros2 specific code and configurations.

* `gz_sim_bringup` - holds launch files and high level utilities.

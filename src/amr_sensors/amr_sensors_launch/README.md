...
launch:
- imu.launch.py: launchs imu with the parameter file xsens_params.yaml.
...
- sensors_main_launch.py: Launchs the sensors main launch files: imu.launch.py, lidar.launch.py, and velodyne_launch.py. 

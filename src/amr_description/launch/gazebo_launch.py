...
def generate_launch_description():
    ...
    return LaunchDescription([
        SetEnvironmentVariable(
            ...
            # [PathJoinSubstitution([example_pkg_path, 'models:']),PathJoinSubstitution([amr_description_pkg_path, 'amr'])]
        ),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(gz_launch_path),
            launch_arguments={
                'gz_args': [PathJoinSubstitution([amr_description_pkg_path, 'worlds/world.sdf -r'])], 
                            # '--gui-config ', 
